...
- Submission, policy lifecycle detail, and reference-data ODCS folders now contain starter contract sets.
...
Continue with remaining backlog contracts such as account, agreement, claim event detail, and financial transaction classification. Target type mapping guidance should follow once the next contract batch stabilizes.
