...
-- Source: pc.cause-of-loss-code v0.4.2 (references/odcs/pc/reference-data/cause-of-loss-code.odcs.yaml)
-- Contract kind: codeset
-- Do not edit by hand. Regenerate via scripts/generation/generate-fabric-ddl.py.

CREATE TABLE IF NOT EXISTS nebula_pc_silver.silver_reference_data.cause_of_loss_code (
  cause_of_loss_code_uid STRING NOT NULL COMMENT 'Immutable system-generated GUID that uniquely identifies the canonical CauseOfLossCode record across snapshots.',
...
COMMENT 'Canonical codeset for the cause of loss classification associated with a claim or claim feature. Source: pc.cause-of-loss-code v0.4.2.'
TBLPROPERTIES (
...
--   OPTIMIZE nebula_pc_silver.silver_reference_data.cause_of_loss_code ZORDER BY (cause_of_loss_code_uid);
