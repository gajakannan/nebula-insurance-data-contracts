...
CREATE TABLE IF NOT EXISTS nebula_pc_silver.silver_reference_data.agreement_type_code (
  agreement_type_code_uid STRING NOT NULL COMMENT 'Immutable system-generated GUID that uniquely identifies the canonical AgreementTypeCode record across snapshots.',
...
--   OPTIMIZE nebula_pc_silver.silver_reference_data.agreement_type_code ZORDER BY (agreement_type_code_uid);
