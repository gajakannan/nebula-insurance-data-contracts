...
CREATE TABLE IF NOT EXISTS nebula_pc_silver.silver_reference_data.term_status_code (
  term_status_code_uid STRING NOT NULL COMMENT 'Immutable system-generated GUID that uniquely identifies the canonical TermStatusCode record across snapshots.',
...
--   OPTIMIZE nebula_pc_silver.silver_reference_data.term_status_code ZORDER BY (term_status_code_uid);
