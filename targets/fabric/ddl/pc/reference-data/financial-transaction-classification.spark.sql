...
-- Source: pc.financial-transaction-classification v0.1.3 (references/odcs/pc/reference-data/financial-transaction-classification.odcs.yaml)
-- Contract kind: codeset
-- Do not edit by hand. Regenerate via scripts/generation/generate-fabric-ddl.py.

CREATE TABLE IF NOT EXISTS nebula_pc_silver.silver_reference_data.financial_transaction_classification (
  financial_transaction_classification_uid STRING NOT NULL COMMENT 'Immutable system-generated GUID that uniquely identifies the canonical FinancialTransactionClassification record across snapshots.',
...
COMMENT 'Canonical codeset for the secondary classification of financial transactions, used by analytics and reporting to roll up transactions across policy and claim sides (INDEMNITY, EXPENSE_ALAE, EXPENSE_ULAE, RESERVE_INDEMNITY, RESERVE_EXPENSE, WRITTEN_PREMIUM, EARNED_PREMIUM, COMMISSION_BASE, etc.). Source: pc.financial-transaction-classification v0.1.3.'
TBLPROPERTIES (
...
--   OPTIMIZE nebula_pc_silver.silver_reference_data.financial_transaction_classification ZORDER BY (financial_transaction_classification_uid);
