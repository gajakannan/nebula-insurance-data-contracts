-- Spark SQL DDL for nebula_pc_silver.silver_reference_data.occurrence_type_code
-- Generated from targets/fabric/manifests/pc/reference-data/occurrence-type-code.fabric.yaml
-- Source: pc.occurrence-type-code v0.1.1 (references/odcs/pc/reference-data/occurrence-type-code.odcs.yaml)
-- Contract kind: codeset
-- Do not edit by hand. Regenerate via scripts/generation/generate-fabric-ddl.py.

CREATE TABLE IF NOT EXISTS nebula_pc_silver.silver_reference_data.occurrence_type_code (
  occurrence_type_code_uid STRING NOT NULL COMMENT 'Immutable system-generated GUID that uniquely identifies the canonical OccurrenceTypeCode record across snapshots.',
...
COMMENT 'Canonical codeset for occurrence classification values such as auto-collision, fire, theft, weather, and bodily-injury. Source: pc.occurrence-type-code v0.1.1.'
TBLPROPERTIES (
...
--   OPTIMIZE nebula_pc_silver.silver_reference_data.occurrence_type_code ZORDER BY (occurrence_type_code_uid);
