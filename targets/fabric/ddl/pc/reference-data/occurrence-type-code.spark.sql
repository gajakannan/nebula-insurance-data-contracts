...
-- Source: pc.occurrence-type-code v0.1.0 (references/odcs/pc/reference-data/occurrence-type-code.odcs.yaml)
...
COMMENT 'Canonical codeset for occurrence classification values such as auto-collision, fire, theft, weather, and bodily-injury. Source: pc.occurrence-type-code v0.1.0.'
TBLPROPERTIES (
