...
CREATE TABLE IF NOT EXISTS nebula_pc_silver.silver_reference_data.submission_status_code (
  submission_status_code_uid STRING NOT NULL COMMENT 'Immutable system-generated GUID that uniquely identifies the canonical SubmissionStatusCode record across snapshots.',
...
--   OPTIMIZE nebula_pc_silver.silver_reference_data.submission_status_code ZORDER BY (submission_status_code_uid);
