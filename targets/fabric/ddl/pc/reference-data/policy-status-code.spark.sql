...
CREATE TABLE IF NOT EXISTS nebula_pc_silver.silver_reference_data.policy_status_code (
  policy_status_code_uid STRING NOT NULL COMMENT 'Immutable system-generated GUID that uniquely identifies the canonical PolicyStatusCode record across snapshots.',
...
--   OPTIMIZE nebula_pc_silver.silver_reference_data.policy_status_code ZORDER BY (policy_status_code_uid);
