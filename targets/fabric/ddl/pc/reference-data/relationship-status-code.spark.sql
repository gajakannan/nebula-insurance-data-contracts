...
-- Source: pc.relationship-status-code v0.1.0 (references/odcs/pc/reference-data/relationship-status-code.odcs.yaml)
...
COMMENT 'Canonical codeset for party relationship lifecycle status values such as active, inactive, and terminated. Source: pc.relationship-status-code v0.1.0.'
TBLPROPERTIES (
