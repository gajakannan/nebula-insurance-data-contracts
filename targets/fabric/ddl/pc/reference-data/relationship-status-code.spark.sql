-- Spark SQL DDL for nebula_pc_silver.silver_reference_data.relationship_status_code
-- Generated from targets/fabric/manifests/pc/reference-data/relationship-status-code.fabric.yaml
-- Source: pc.relationship-status-code v0.1.1 (references/odcs/pc/reference-data/relationship-status-code.odcs.yaml)
-- Contract kind: codeset
-- Do not edit by hand. Regenerate via scripts/generation/generate-fabric-ddl.py.

CREATE TABLE IF NOT EXISTS nebula_pc_silver.silver_reference_data.relationship_status_code (
  relationship_status_code_uid STRING NOT NULL COMMENT 'Immutable system-generated GUID that uniquely identifies the canonical RelationshipStatusCode record across snapshots.',
...
COMMENT 'Canonical codeset for party relationship lifecycle status values such as active, inactive, and terminated. Source: pc.relationship-status-code v0.1.1.'
TBLPROPERTIES (
...
--   OPTIMIZE nebula_pc_silver.silver_reference_data.relationship_status_code ZORDER BY (relationship_status_code_uid);
