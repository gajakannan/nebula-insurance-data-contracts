...
CREATE TABLE IF NOT EXISTS nebula_pc_silver.silver_reference_data.coverage_level_code (
  coverage_level_code_uid STRING NOT NULL COMMENT 'Immutable system-generated GUID that uniquely identifies the canonical CoverageLevelCode record across snapshots.',
...
--   OPTIMIZE nebula_pc_silver.silver_reference_data.coverage_level_code ZORDER BY (coverage_level_code_uid);
