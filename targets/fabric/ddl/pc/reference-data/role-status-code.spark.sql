...
CREATE TABLE IF NOT EXISTS nebula_pc_silver.silver_reference_data.role_status_code (
  role_status_code_uid STRING NOT NULL COMMENT 'Immutable system-generated GUID that uniquely identifies the canonical RoleStatusCode record across snapshots.',
...
--   OPTIMIZE nebula_pc_silver.silver_reference_data.role_status_code ZORDER BY (role_status_code_uid);
