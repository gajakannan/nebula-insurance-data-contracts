...
-- Source: pc.submission-type-code v0.1.0 (references/odcs/pc/reference-data/submission-type-code.odcs.yaml)
...
COMMENT 'Canonical codeset for submission classification values such as new business, renewal, mid-term endorsement, and rewrite. Source: pc.submission-type-code v0.1.0.'
TBLPROPERTIES (
