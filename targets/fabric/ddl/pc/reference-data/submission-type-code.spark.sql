-- Spark SQL DDL for nebula_pc_silver.silver_reference_data.submission_type_code
-- Generated from targets/fabric/manifests/pc/reference-data/submission-type-code.fabric.yaml
-- Source: pc.submission-type-code v0.1.1 (references/odcs/pc/reference-data/submission-type-code.odcs.yaml)
-- Contract kind: codeset
-- Do not edit by hand. Regenerate via scripts/generation/generate-fabric-ddl.py.

CREATE TABLE IF NOT EXISTS nebula_pc_silver.silver_reference_data.submission_type_code (
  submission_type_code_uid STRING NOT NULL COMMENT 'Immutable system-generated GUID that uniquely identifies the canonical SubmissionTypeCode record across snapshots.',
...
COMMENT 'Canonical codeset for submission classification values such as new business, renewal, mid-term endorsement, and rewrite. Source: pc.submission-type-code v0.1.1.'
TBLPROPERTIES (
...
--   OPTIMIZE nebula_pc_silver.silver_reference_data.submission_type_code ZORDER BY (submission_type_code_uid);
