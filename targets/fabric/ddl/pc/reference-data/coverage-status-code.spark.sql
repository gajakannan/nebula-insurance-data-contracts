...
CREATE TABLE IF NOT EXISTS nebula_pc_silver.silver_reference_data.coverage_status_code (
  coverage_status_code_uid STRING NOT NULL COMMENT 'Immutable system-generated GUID that uniquely identifies the canonical CoverageStatusCode record across snapshots.',
...
--   OPTIMIZE nebula_pc_silver.silver_reference_data.coverage_status_code ZORDER BY (coverage_status_code_uid);
