...
CREATE TABLE IF NOT EXISTS nebula_pc_silver.silver_reference_data.jurisdiction_code (
  jurisdiction_code_uid STRING NOT NULL COMMENT 'Immutable system-generated GUID that uniquely identifies the canonical JurisdictionCode record across snapshots.',
  ...
  external_standard_code STRING COMMENT 'Code value as defined by ISO 3166-2 when a mapping is recorded.',
...
--   OPTIMIZE nebula_pc_silver.silver_reference_data.jurisdiction_code ZORDER BY (jurisdiction_code_uid);
