...
-- Source: pc.relationship-type-code v0.1.0 (references/odcs/pc/reference-data/relationship-type-code.odcs.yaml)
...
COMMENT 'Canonical codeset for party relationship type values such as parent, subsidiary, affiliate, predecessor, and successor. Source: pc.relationship-type-code v0.1.0.'
TBLPROPERTIES (
