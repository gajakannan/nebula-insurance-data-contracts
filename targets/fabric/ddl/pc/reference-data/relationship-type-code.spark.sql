-- Spark SQL DDL for nebula_pc_silver.silver_reference_data.relationship_type_code
-- Generated from targets/fabric/manifests/pc/reference-data/relationship-type-code.fabric.yaml
-- Source: pc.relationship-type-code v0.1.1 (references/odcs/pc/reference-data/relationship-type-code.odcs.yaml)
-- Contract kind: codeset
-- Do not edit by hand. Regenerate via scripts/generation/generate-fabric-ddl.py.

CREATE TABLE IF NOT EXISTS nebula_pc_silver.silver_reference_data.relationship_type_code (
  relationship_type_code_uid STRING NOT NULL COMMENT 'Immutable system-generated GUID that uniquely identifies the canonical RelationshipTypeCode record across snapshots.',
...
COMMENT 'Canonical codeset for party relationship type values such as parent, subsidiary, affiliate, predecessor, and successor. Source: pc.relationship-type-code v0.1.1.'
TBLPROPERTIES (
...
--   OPTIMIZE nebula_pc_silver.silver_reference_data.relationship_type_code ZORDER BY (relationship_type_code_uid);
