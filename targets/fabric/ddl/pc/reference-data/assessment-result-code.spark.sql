...
CREATE TABLE IF NOT EXISTS nebula_pc_silver.silver_reference_data.assessment_result_code (
  assessment_result_code_uid STRING NOT NULL COMMENT 'Immutable system-generated GUID that uniquely identifies the canonical AssessmentResultCode record across snapshots.',
...
--   OPTIMIZE nebula_pc_silver.silver_reference_data.assessment_result_code ZORDER BY (assessment_result_code_uid);
