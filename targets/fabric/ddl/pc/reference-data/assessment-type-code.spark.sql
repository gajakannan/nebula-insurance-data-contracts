...
CREATE TABLE IF NOT EXISTS nebula_pc_silver.silver_reference_data.assessment_type_code (
  assessment_type_code_uid STRING NOT NULL COMMENT 'Immutable system-generated GUID that uniquely identifies the canonical AssessmentTypeCode record across snapshots.',
...
--   OPTIMIZE nebula_pc_silver.silver_reference_data.assessment_type_code ZORDER BY (assessment_type_code_uid);
