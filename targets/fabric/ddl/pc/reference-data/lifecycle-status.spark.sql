-- Spark SQL DDL for nebula_pc_silver.silver_reference_data.lifecycle_status
-- Generated from targets/fabric/manifests/pc/reference-data/lifecycle-status.fabric.yaml
-- Source: pc.lifecycle-status v0.4.1 (references/odcs/pc/reference-data/lifecycle-status.odcs.yaml)
-- Contract kind: codeset
-- Do not edit by hand. Regenerate via scripts/generation/generate-fabric-ddl.py.

CREATE TABLE IF NOT EXISTS nebula_pc_silver.silver_reference_data.lifecycle_status (
  lifecycle_status_uid STRING NOT NULL COMMENT 'Immutable system-generated GUID that uniquely identifies the canonical lifecycle status record across snapshots and source systems.',
  ...
  lifecycle_subject_code STRING NOT NULL COMMENT 'Classification of the business subject to which the lifecycle status applies.',
  active_status_indicator BOOLEAN COMMENT 'Indicates whether the lifecycle status represents an active business state.',
  terminal_status_indicator BOOLEAN COMMENT 'Indicates whether the lifecycle status represents a terminal business state.',
  lifecycle_status_status_code STRING NOT NULL COMMENT 'Current lifecycle status of the lifecycle status reference record.',
  effective_date DATE COMMENT 'Date when the lifecycle status reference record becomes effective for canonical use.',
  expiration_date DATE COMMENT 'Date when the lifecycle status reference record stops being effective for canonical use.',
...
COMMENT 'Canonical contract for lifecycle status reference data used across Property and Casualty contracts. Source: pc.lifecycle-status v0.4.1.'
TBLPROPERTIES (
...
--   OPTIMIZE nebula_pc_silver.silver_reference_data.lifecycle_status ZORDER BY (lifecycle_status_uid);
