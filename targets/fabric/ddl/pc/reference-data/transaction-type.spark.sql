-- Spark SQL DDL for nebula_pc_silver.silver_reference_data.transaction_type
-- Generated from targets/fabric/manifests/pc/reference-data/transaction-type.fabric.yaml
-- Source: pc.transaction-type v0.4.3 (references/odcs/pc/reference-data/transaction-type.odcs.yaml)
-- Contract kind: codeset
-- Do not edit by hand. Regenerate via scripts/generation/generate-fabric-ddl.py.

CREATE TABLE IF NOT EXISTS nebula_pc_silver.silver_reference_data.transaction_type (
  transaction_type_uid STRING NOT NULL COMMENT 'Immutable system-generated GUID that uniquely identifies the canonical transaction type record across snapshots and source systems.',
  ...
  transaction_category_code STRING COMMENT 'Higher-level grouping for related transaction types.',
  financial_transaction_indicator BOOLEAN COMMENT 'Indicates whether the transaction type is used for monetary activity.',
  lifecycle_event_indicator BOOLEAN COMMENT 'Indicates whether the transaction type is used for lifecycle event activity.',
  transaction_type_status_code STRING NOT NULL COMMENT 'Current lifecycle status of the transaction type reference record.',
  effective_date DATE COMMENT 'Date when the transaction type reference record becomes effective for canonical use.',
  expiration_date DATE COMMENT 'Date when the transaction type reference record stops being effective for canonical use.',
...
COMMENT 'Canonical contract for transaction type reference data used across Property and Casualty operational and financial activity. Source: pc.transaction-type v0.4.3.'
TBLPROPERTIES (
...
--   OPTIMIZE nebula_pc_silver.silver_reference_data.transaction_type ZORDER BY (transaction_type_uid);
