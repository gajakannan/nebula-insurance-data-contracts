...
-- Source: pc.transaction-type v0.4.1 (references/odcs/pc/reference-data/transaction-type.odcs.yaml)
...
COMMENT 'Canonical contract for transaction type reference data used across Property and Casualty operational and financial activity. Source: pc.transaction-type v0.4.1.'
TBLPROPERTIES (
