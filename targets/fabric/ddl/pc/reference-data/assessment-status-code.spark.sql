...
-- Source: pc.assessment-status-code v0.1.1 (references/odcs/pc/reference-data/assessment-status-code.odcs.yaml)
...
COMMENT 'Canonical codeset for submission assessment lifecycle status values such as in-progress, complete, and superseded. Source: pc.assessment-status-code v0.1.1.'
TBLPROPERTIES (
