-- Spark SQL DDL for nebula_pc_silver.silver_reference_data.assessment_status_code
-- Generated from targets/fabric/manifests/pc/reference-data/assessment-status-code.fabric.yaml
-- Source: pc.assessment-status-code v0.1.0 (references/odcs/pc/reference-data/assessment-status-code.odcs.yaml)
-- Contract kind: codeset
-- Do not edit by hand. Regenerate via scripts/generation/generate-fabric-ddl.py.

CREATE TABLE IF NOT EXISTS nebula_pc_silver.silver_reference_data.assessment_status_code (
  assessment_status_code_uid STRING NOT NULL COMMENT 'Immutable system-generated GUID that uniquely identifies the canonical AssessmentStatusCode record across snapshots.',
...
COMMENT 'Canonical codeset for submission assessment lifecycle status values such as in-progress, complete, and superseded. Source: pc.assessment-status-code v0.1.0.'
TBLPROPERTIES (
...
--   OPTIMIZE nebula_pc_silver.silver_reference_data.assessment_status_code ZORDER BY (assessment_status_code_uid);
