...
-- Source: pc.record-status-code v0.4.1 (references/odcs/pc/reference-data/record-status-code.odcs.yaml)
...
COMMENT 'Canonical codeset for warehouse-level record state. Allowed values include ACTIVE, SUPERSEDED, SOFT_DELETED, RESTATED, and MERGED per the record-state ADR. Source: pc.record-status-code v0.4.1.'
TBLPROPERTIES (
