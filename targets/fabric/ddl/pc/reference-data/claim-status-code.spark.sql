-- Spark SQL DDL for nebula_pc_silver.silver_reference_data.claim_status_code
-- Generated from targets/fabric/manifests/pc/reference-data/claim-status-code.fabric.yaml
-- Source: pc.claim-status-code v0.4.0 (references/odcs/pc/reference-data/claim-status-code.odcs.yaml)
-- Contract kind: codeset
-- Do not edit by hand. Regenerate via scripts/generation/generate-fabric-ddl.py.

CREATE TABLE IF NOT EXISTS nebula_pc_silver.silver_reference_data.claim_status_code (
  claim_status_code_uid STRING NOT NULL COMMENT 'Immutable system-generated GUID that uniquely identifies the canonical ClaimStatusCode record across snapshots.',
...
COMMENT 'Canonical codeset for claim lifecycle status values such as open, closed, reopened, denied, and withdrawn. Source: pc.claim-status-code v0.4.0.'
TBLPROPERTIES (
...
--   OPTIMIZE nebula_pc_silver.silver_reference_data.claim_status_code ZORDER BY (claim_status_code_uid);
