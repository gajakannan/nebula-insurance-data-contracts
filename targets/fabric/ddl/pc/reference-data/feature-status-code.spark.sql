...
-- Source: pc.feature-status-code v0.1.2 (references/odcs/pc/reference-data/feature-status-code.odcs.yaml)
...
COMMENT 'Canonical codeset for claim feature lifecycle status values such as open, closed, reopened, and waived. Source: pc.feature-status-code v0.1.2.'
TBLPROPERTIES (
