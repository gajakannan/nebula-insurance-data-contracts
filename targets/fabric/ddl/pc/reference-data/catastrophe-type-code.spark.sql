...
CREATE TABLE IF NOT EXISTS nebula_pc_silver.silver_reference_data.catastrophe_type_code (
  catastrophe_type_code_uid STRING NOT NULL COMMENT 'Immutable system-generated GUID that uniquely identifies the canonical CatastropheTypeCode record across snapshots.',
...
--   OPTIMIZE nebula_pc_silver.silver_reference_data.catastrophe_type_code ZORDER BY (catastrophe_type_code_uid);
