...
CREATE TABLE IF NOT EXISTS nebula_pc_silver.silver_reference_data.account_status_code (
  account_status_code_uid STRING NOT NULL COMMENT 'Immutable system-generated GUID that uniquely identifies the canonical AccountStatusCode record across snapshots.',
...
--   OPTIMIZE nebula_pc_silver.silver_reference_data.account_status_code ZORDER BY (account_status_code_uid);
