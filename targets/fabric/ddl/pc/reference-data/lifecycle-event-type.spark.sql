...
-- Source: pc.lifecycle-event-type v0.4.1 (references/odcs/pc/reference-data/lifecycle-event-type.odcs.yaml)
...
COMMENT 'Canonical contract for lifecycle event type reference data used across Property and Casualty business lifecycles. Source: pc.lifecycle-event-type v0.4.1.'
TBLPROPERTIES (
