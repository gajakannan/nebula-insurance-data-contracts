...
CREATE TABLE IF NOT EXISTS nebula_pc_silver.silver_reference_data.party_role_type_code (
  party_role_type_code_uid STRING NOT NULL COMMENT 'Immutable system-generated GUID that uniquely identifies the canonical PartyRoleTypeCode record across snapshots.',
...
--   OPTIMIZE nebula_pc_silver.silver_reference_data.party_role_type_code ZORDER BY (party_role_type_code_uid);
