...
-- Source: pc.vehicle-exposure v0.4.2 (references/odcs/pc/exposure/vehicle-exposure.odcs.yaml)
...
COMMENT 'Canonical contract for vehicle-specific exposure attributes in Property and Casualty insurance. Source: pc.vehicle-exposure v0.4.2.'
TBLPROPERTIES (
