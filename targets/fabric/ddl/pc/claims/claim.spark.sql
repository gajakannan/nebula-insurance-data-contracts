...
-- Source: pc.claim v0.4.4 (references/odcs/pc/claims/claim.odcs.yaml)
...
COMMENT 'Canonical contract for Property and Casualty claim identity, loss context, and current claim summary. Source: pc.claim v0.4.4.'
TBLPROPERTIES (
