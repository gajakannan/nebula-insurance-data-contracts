...
-- Source: pc.claim-party-role v0.4.2 (references/odcs/pc/claims/claim-party-role.odcs.yaml)
...
COMMENT 'Canonical contract for a party participating in a Property and Casualty claim context. Source: pc.claim-party-role v0.4.2.'
TBLPROPERTIES (
