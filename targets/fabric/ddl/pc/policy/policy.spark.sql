...
-- Source: pc.policy v0.4.2 (references/odcs/pc/policy/policy.odcs.yaml)
...
COMMENT 'Canonical contract for durable Property and Casualty policy identity and current policy summary. Source: pc.policy v0.4.2.'
TBLPROPERTIES (
