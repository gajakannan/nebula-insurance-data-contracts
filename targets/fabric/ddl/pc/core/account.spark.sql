...
-- Source: pc.account v0.1.2 (references/odcs/pc/core/account.odcs.yaml)
...
COMMENT 'Canonical contract for a commercial-lines account — the master customer record that owns one or more policies, agreements, and submissions. Source: pc.account v0.1.2.'
TBLPROPERTIES (
